...
export const ANALYTICS_WIDGETS = [
  ...
  { id: "stat_expectancy",   label: "Expectancy",            category: "stats" },
  { id: "stat_avgwin",       label: "Avg Win",               category: "stats" },
  { id: "stat_avgloss",      label: "Avg Loss",              category: "stats" },
  { id: "stat_beststrade",   label: "Best Trade",            category: "stats" },
  { id: "stat_worstrade",    label: "Worst Trade",           category: "stats" },
  { id: "stat_avgrr",        label: "Avg R:R",               category: "stats" },
  { id: "profit_chart",      label: "Profit Chart",          category: "charts" },
  { id: "balance_chart",     label: "Balance Chart",         category: "charts" },
  { id: "equity_curve",      label: "Equity Curve",          category: "charts" },
  { id: "risk_panel",        label: "Risk Stats",            category: "charts" },
  { id: "symbols_breakdown", label: "Symbols Breakdown",     category: "charts" },
...
export default function AddAnalyticsWidgetSidebar({ activeWidgets, onAdd, onClose }) {
  const [search, setSearch] = useState("");
  const [cat, setCat] = useState("all");

  const filtered = ANALYTICS_WIDGETS.filter(w => {
    ...
    <div className="fixed inset-y-0 right-0 z-50 w-80 bg-card border-l border-border shadow-2xl flex flex-col">
      <div className="flex items-center justify-between px-5 py-4 border-b border-border">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">Click to add to analytics</p>
        </div>
