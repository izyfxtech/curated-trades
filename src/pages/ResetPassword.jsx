...
export default function ResetPassword() {
  ...
  // Supabase delivers the access token via URL hash when the user clicks
  // the reset link; the Supabase JS client picks it up automatically.
  ...
  if (done) {
    return (
      <AuthLayout icon={Lock} title="Password updated" subtitle="Redirecting you to login…">
        <p className="text-sm text-center text-muted-foreground">Your password has been changed successfully.</p>
      </AuthLayout>
    );
  }
